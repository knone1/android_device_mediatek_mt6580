...
void healthd_board_init(struct healthd_config *config)
{
    ...
    config->batteryVoltagePath     = "/sys/class/power_supply/battery/ChargerVoltage";
    config->batteryTemperaturePath = "/sys/class/power_supply/battery/TempBattVoltage";
    config->batteryTechnologyPath  = "/sys/class/power_supply/battery/technology";
    config->batteryChargeCounterPath  = "/sys/class/power_supply/battery/capacity";
    config->batteryCurrentNowPath  = "/sys/class/power_supply/battery/BatteryAverageCurrent";
    config->batteryCurrentAvgPath  = "/sys/class/power_supply/battery/BatterySenseVoltage";
